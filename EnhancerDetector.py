...
parser.add_argument("--custom_model", default=None, help="Path to custom fine-tuned model file.")
...
if args.custom_model:
    # Load user-provided model and indexer

    model = load_model(args.custom_model, custom_objects={'CustomConvLayer': CustomConvLayer, 'specificity': specificity, 'weighted_f1_score': weighted_f1_score})
    print("Using Custom Finetuned Model")
    with open("Models/Human/indexer.pkl", 'rb') as f:
